    ...
    <Formik
      ...
      validationSchema={Yup.object({
        name: Yup.string()
          ...
          .required(
            "Ese dato es muy importante!! Si no nos quieres dar tu nombre ingresa como anonimo"
          ),
        type: Yup.string().required("Debes elegir una operacion!!"),
        cantidad: Yup.string().required(
          "Debes elegir una cantidad de ejercicios!!"
        ),
      })}
      onSubmit={handleSubmit}
    >
      <Form style={{ padding: 20, margin: 25 }}>
        <h2>Hola desconocido!!</h2>
        <p>
          Creo que quieres ejercitar tu capacidad de razonamiento matematico, en
          busca de enriquecer tus capacidades para tener un futuro en el que
          planea...o bueno, simplemente quieres realizar ejercicios matematicos.
        </p>
        ...
        <Collapse isOpen={collapse}>
          <h5>
            La verdad esa es toda la presentacion que nesecitamos, lo que tu
            vienes a hacer es a ejercitar!!
          </h5>
